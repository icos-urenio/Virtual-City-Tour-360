...
$canOrder	= $user->authorise('core.edit.state', 'com_virtualcitytour360');
$saveOrder	= $listOrder == 'a.ordering';
?>

<form action="<?php echo JRoute::_('index.php?option=com_virtualcitytour360&view=items'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
                ...
                <th width="54%" class="nowrap">
                    <?php echo JHtml::_('grid.sort',  'COM_VIRTUALCITYTOUR360_VIRTUALCITYTOUR360_HEADING_TITLE', 'a.title', $listDirn, $listOrder); ?>
                </th>
                <?php } ?>
                ...
                <th width="30%" class="nowrap">
                    <?php echo JHtml::_('grid.sort',  'COM_VIRTUALCITYTOUR360_VIRTUALCITYTOUR360_HEADING_CATEGORY', 'a.catid', $listDirn, $listOrder); ?>
                </th>
                <?php } ?>				
		...
		<?php foreach ($this->items as $i => $item) :
			...
			$canCreate	= $user->authorise('core.create',		'com_virtualcitytour360');
			$canEdit	= $user->authorise('core.edit',			'com_virtualcitytour360');
			$canCheckin	= $user->authorise('core.manage',		'com_virtualcitytour360');
			$canChange	= $user->authorise('core.edit.state',	'com_virtualcitytour360');
			?>
			<tr class="row<?php echo $i % 2; ?>">
                ...
                <?php if (isset($this->items[0]->title)) { ?>
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_virtualcitytour360&task=item.edit&id=' . $item->id); ?>">
						<?php echo $item->title; ?>
					</a>		
					<br />
				</td>
