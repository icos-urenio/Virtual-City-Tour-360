...
<div id="imc-wrapper" class="imc <?php echo $this->pageclass_sfx; ?>">
	...
	<div id="imc-content">
		<div id="imc-main-panel">
			<div id="mapCanvasNew"><?php echo JText::_('COM_VIRTUALCITYTOUR360');?></div>
		</div>
		<div id="imc-details-sidebar">
			<div id="imc-new-issue">
				...
				<?php endif;?>
				<form class="form-validate" action="<?php echo ('index.php?option=com_virtualcitytour360&view=pois'); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">					
					<fieldset>
						...
						<?php if(!$this->guest) {?>
							<button class="btn btn-success imc-right" onclick="Joomla.submitbutton('poi.save');void(0);"><i class="icon-ok icon-white"></i> <?php echo JText::_('POST_ISSUE') ?></button>
